...
#define USE_DEFAULT_PHILIPS_COMMAND_SET
        ...
        const std::vector<uint8_t> command_pre_power_on =
            {0xD5, 0x55, 0x0A, 0x01, 0x05, 0x01, 0x16, 0x00, 0x00, 0x00, 0x1F, 0x3E};
        const std::vector<uint8_t> command_power_with_cleaning =
            {0xD5, 0x55, 0x01, 0x01, 0x05, 0x01, 0x16, 0x00, 0x00, 0x00, 0x34, 0x0B};
        const std::vector<uint8_t> command_power_without_cleaning = //not edited
            {0xD5, 0x55, 0x01, 0x01, 0x03, 0x00, 0x0E, 0x00, 0x00, 0x00, 0x01, 0x25};
        const std::vector<uint8_t> command_power_off =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x01, 0x00, 0x00, 0x0C, 0x17};
        const std::vector<uint8_t> command_press_play_pause =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x00, 0x01, 0x08, 0x1E};
        /// @brief EP3347: Press Coffee Button
        const std::vector<uint8_t> command_press_1 =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x20, 0x00, 0x00, 0x31, 0x3B};
        /// @brief EP3347: Press Espresso Button
        const std::vector<uint8_t> command_press_2 =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x02, 0x00, 0x00, 0x18, 0x01};
        /// @brief EP3347: Press Hot water Button
        const std::vector<uint8_t> command_press_3 =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x10, 0x00, 0x00, 0x18, 0x0A};
        /// @brief EP3347: Press Latte Button
        const std::vector<uint8_t> command_press_4 =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x08, 0x00, 0x00, 0x28, 0x30};
        /// @brief EP3347: Press Iced coffee
        const std::vector<uint8_t> command_press_5 =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x04, 0x00, 0x00, 0x30, 0x2D};
        /// @brief EP3243 & EP3347: Press cappuccino Button
        const std::vector<uint8_t> command_press_6 = //not edited
            {0xD5, 0x55, 0x00, 0x01, 0x03, 0x00, 0x0E, 0x04, 0x00, 0x00, 0x05, 0x03};
        const std::vector<uint8_t> command_press_bean =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x02, 0x00, 0x18, 0x03};
        const std::vector<uint8_t> command_press_size =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x04, 0x00, 0x31, 0x29};
        const std::vector<uint8_t> command_press_milk =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x01, 0x00, 0x0C, 0x16};
        const std::vector<uint8_t> command_press_aqua_clean =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x10, 0x00, 0x1C, 0x1A};
        const std::vector<uint8_t> command_press_calc_clean =
            {0xD5, 0x55, 0x00, 0x01, 0x05, 0x01, 0x16, 0x00, 0x20, 0x00, 0x39, 0x1B};
#else
#define USE_DEFAULT_PHILIPS_COMMAND_SET
#endif
